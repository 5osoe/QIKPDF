...
async function openSinglePagePreview(doc, pageNum, title = "PREVIEW") {
    ...
    try {
        ...
        // --- DYNAMIC SCALE CALCULATION START ---
        // Need to wait slightly for modal to be flexed correctly
