...
document.addEventListener("DOMContentLoaded", () => {
    initTheme(); 
    // Language init removed (Defaulting to English)
    updateUIText(); // Apply English text once
...
// --- LANGUAGE UTILS (SIMPLIFIED TO ENGLISH ONLY) ---
function getT(key) {
...
async function init() {
    try {
        // Loads English content directly
