...
const DOM = {
    ...
    btnLang: document.getElementById('btn-lang'), // New Lang Button
...
function applyLanguage(lang) {
    ...
    // ISOLATION: Apply RTL only to #app-root
    if (root) {
        root.setAttribute('dir', lang === 'ar' ? 'rtl' : 'ltr');
    }
    // Keep lang on html for metadata, but NOT dir
...
function updateUIText() {
    ...
    // Update Labels (Data-i18n approach simulation)
        ...
        let html = `
            <div class="info-panel">
                <div class="info-header-block">
                    ...
                    <div class="info-filesize">${fileSizeKB} KB</div>
                </div>
                ...
                <div class="info-grid">
                    ...
                    ${createRow('dimensionsLabel', `${width} x ${height} pt`)}
                </div>
